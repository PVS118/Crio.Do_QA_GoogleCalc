...
public class TestCases {
    ...
    public void testCase01() {
        ...
        String expectedURL = "https://www.google.com/search?q=calculator";
        if (currentURL.equals(expectedURL)) {
            System.out.println(" Homepage URL verification passed.");
        } else {
            System.out.println(" Homepage URL verification failed. Actual URL: " + currentURL);
        }
        ...
        WebElement calculatorLoads = driver.findElement(By.xpath("//*[@id=\"rso\"]/div[1]/div/div/div"));

        if (calculatorLoads.isDisplayed()) {
            System.out.println(" Google Calculator loaded successfully.");
        } else {
            System.out.println(" Google Calculator did not load as successfully.");
        }

        //Confirm that the initial display shows zero(0)
        WebElement calculatorResult = driver.findElement(By.xpath("//*[@id=\"cwos\"]"));
        String resultValue = calculatorResult.getText();

        if (calculatorResult.isDisplayed()) {
